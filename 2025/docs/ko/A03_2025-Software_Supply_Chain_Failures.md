...
* 2019년 솔라윈즈(Solarwinds) 침해사고는 18,000개의 조직 침해사고로 이어졌다.[https://www.npr.org/2021/04/16/985439655/a-worst-nightmare-cyberattack-the-untold-story-of-the-solarwinds-hack](https://www.npr.org/2021/04/16/985439655/a-worst-nightmare-cyberattack-the-untold-story-of-the-solarwinds-hack)
...
**시나리오 4:** 컴포넌트는 일반적으로 애플리케이션과 동일한 권한 실행되므로, 컴포넌트의 취약점이 심각한 영향을 미칠 수 있다. 해당 취약점은 우발적이거나(예: 코딩 에러), 고의적일 수 있으며,(예: 컴포넌트 내 백도어) 발견된 악용 가능한 컴포넌트 취약점 대표적 사례는 다음과 같다. 
